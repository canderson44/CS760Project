...
caseA_comparison <- barplot(height=as.numeric(F1_meas[1:2]), names=row_labels[1:2],ylab="F1 Measure", ylim=c(0,1), col="brown",density=c(30,10) , angle=c(11,90))
...
caseB_comparison <- barplot(height=as.numeric(F1_meas[3:4]), names=row_labels[3:4],ylab="F1 Measure", ylim=c(0,1), col="#69b3a2",density=c(30,10) , angle=c(11,90))
